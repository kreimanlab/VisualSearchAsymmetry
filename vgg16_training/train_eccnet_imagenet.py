...
from eccnet import load_eccNET
...
with strategy.scope():
    model = load_eccNET((224, 224, 3), freeze_filters=True) # freeze_filters=False to finetune all the layers
...
save_dir = "./saved_model/eccNET_Imagenet_WD_Adam/"
save_ver = 0
